...
def startNetwork():
    ...
    hosts = [h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13, h14, h15, h16, h17, h18]
    ...
    print("--------------------------------------------------------------------------------")   
    src.cmd("timeout 10s hping3 -1 -V -d 120 -w 64 -p 80 --rand-source --flood {}".format(dst))  
    sleep(100)
    ...
    print("--------------------------------------------------------------------------------")   
    src.cmd("timeout 10s hping3 -2 -V -d 120 -w 64 --rand-source --flood {}".format(dst))    
    sleep(100)
    ...
    print("--------------------------------------------------------------------------------")
    src.cmd("timeout 10s hping3 -S -V -d 120 -w 64 -p 80 --rand-source --flood {}".format(dst))
    sleep(100)
    ...
    print("--------------------------------------------------------------------------------")   
    src.cmd("timeout 10s hping3 -1 -V -d 120 -w 64 --flood -a {} {}".format(dst,dst))
    sleep(100)  
    print("--------------------------------------------------------------------------------")
